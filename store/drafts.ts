...
export const PhaseDataVaildator = z.object({
    lowNet: z.number(),
    highNet: z.number(),
...
export const DraftDataVaildator = z.object({
    team: z.number(),
    color: z.literal(0).or(z.literal(1)),
    comments: z.string(),
    driverRating: z.literal(1).or(z.literal(2).or(z.literal(3).or(z.literal(4).or(z.literal(5))))),
    defenseRating: z.literal(1).or(z.literal(2).or(z.literal(3).or(z.literal(4).or(z.literal(5))))),
    name: z.string(),
